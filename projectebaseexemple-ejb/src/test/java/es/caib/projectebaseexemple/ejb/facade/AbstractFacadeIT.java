...
import es.caib.projectebaseexemple.service.exception.ServiceException;
    ...
    public static JavaArchive createDeployment() {
        try {
            JavaArchive jar = ShrinkWrap.create(JavaArchive.class, "test.jar")
                    .addPackages(true, "es.caib.projectebaseexemple.ejb")
                    .addPackages(true, "es.caib.projectebaseexemple.persistence")
                    .addPackages(true, "es.caib.projectebaseexemple.service")
                    .addAsResource(
