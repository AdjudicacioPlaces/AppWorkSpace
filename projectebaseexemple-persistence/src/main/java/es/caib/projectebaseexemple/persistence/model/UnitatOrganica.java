...
import es.caib.projectebaseexemple.service.model.EstatPublicacio;
 ...
 */
@Entity
@SequenceGenerator(name = "uo-sequence", sequenceName = "PBE_UNITATORGANICA_SEQ", allocationSize = 1)
@Table(name = "PBE_UNITATORGANICA",
        uniqueConstraints = {
                @UniqueConstraint(name = "PBE_UNITAT_CODIDIR3_UK", columnNames = "CODIDIR3")
        },
        indexes = {
                @Index(name = "PBE_UNITAT_PK_I", columnList = "ID"),
                @Index(name = "PBE_UNITAT_CODIDIR3_UK_I", columnList = "CODIDIR3")
        }
)
@NamedQueries({
