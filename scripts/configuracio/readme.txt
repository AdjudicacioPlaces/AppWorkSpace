...
amb la propietat de sistema "es.caib.projectebaseexemple.properties".
...
a dins l'apartat de <system-properties>:
    ...
    ...
    <system-properties>
        <property name="es.caib.projectebaseexemple.properties" value="/ruta/cap/al/fitxer/projectebaseexemple.properties"/>
    </system-properties>
    ...
